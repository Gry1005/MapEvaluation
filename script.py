...
def default_evaluation_params():
    ...
    return {
                ...
                'LTRB':3, #Type 1 LTRB:2points(left,top,right,bottom) or Type 2: 4 points(x1,y1,x2,y2,x3,y3,x4,y4) or Type 3 mutiple points points(x1,y1,x2,y2,x3,y3,x4,y4,x5,y5...)
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    def polygon_from_polypoints(points):
        ...
        resBoxes=np.empty([len(points)/2,2],dtype='int32')
