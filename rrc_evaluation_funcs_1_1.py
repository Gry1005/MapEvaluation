...
def print_help():
    sys.stdout.write('Usage: python %s.py -g=<gtFolder> -s=<submFolder> [-o=<outputFolder> -p=<jsonParams>]' %sys.argv[0])
    sys.exit(2)
...
def validate_lines_in_file(fileName,file_contents,CRLF=True,LTRB=2,withTranscription=False,withConfidence=False,imWidth=0,imHeight=0):
    """
...
def validate_tl_line(line,LTRB=2,withTranscription=True,withConfidence=True,imWidth=0,imHeight=0):
    """
